...
public:
	matrix_error(const char* message) : std::exception(message) {}
};
...
public:
	...
	Matrix(size_t row_count_, size_t col_count_)
	{
...
private:
	...
	size_t row_count;
	size_t col_count;
	const size_t get_index(size_t row, size_t col) const
	{
