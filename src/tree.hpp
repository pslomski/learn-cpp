...
public:
	...
	void traverse_preorder(std::function<void(const T& val)> f)
	{
		traverse_preorder(root, f);
	}
	void traverse_inorder(std::function<void(const T& val)> f)
	{
		traverse_inorder(root, f);
	}
	void traverse_postorder(std::function<void(const T& val)> f)
	{
